...
const BecomePosp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 py-12 md:py-20 px-5 md:px-8 lg:px-12 xl:px-20 font-sans flex items-center justify-center">
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            <div
              ...
              onClick={closeSuccessPopup}
            />
            <div className={`relative transform overflow-hidden rounded-[32px] bg-white p-8 md:p-10 shadow-2xl transition-all ${
              animateSuccess ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
            }`}>
              <div className="flex flex-col items-center text-center">
                <div className="relative">
                ...
                <div className="mt-8 flex gap-4 justify-center">
                  <button
                    type="button"
                    onClick={closeSuccessPopup}
                    className="px-6 py-3 bg-primary-blue hover:bg-blue-850 text-white font-semibold rounded-xl shadow-md transition-all duration-200 cursor-pointer"
                  >
                    Go to Login Now
                  </button>
                  <button
      ...
      <div className="flex flex-col lg:flex-row gap-10 w-full max-w-[1280px] mx-auto items-stretch">
        ...
        <div className="lg:w-1/2 order-1 lg:order-2 flex flex-col">
          <div className="bg-white rounded-[32px] shadow-2xl p-8 md:p-10 border border-slate-100 flex-grow">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-black text-gray-900 mb-2 font-sora tracking-tight">
                Create POSP Account
              </h2>
              <p className="text-gray-500 text-sm font-semibold">Fill in the details below to register</p>
            </div>
            ...
            {signupError && !success && Object.keys(backendErrors).length === 0 && (
              <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
                <div className="flex items-center">
                  ...
                  <p className="text-red-800 font-semibold text-sm">{signupError}</p>
                </div>
              </div>
            )}
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="name" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <User className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    Full Name
                  </label>
                  <div className="relative">
                    <input
                ...
                {/* PAN Number */}
                <div>
                  <label htmlFor="panno" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <CreditCard className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    PAN Number
                  </label>
                  <div className="relative">
                    <input
                      ...
                      maxLength="10"
                    />
                    <CreditCard className={`absolute left-3 top-3.5 w-5 h-5 ${
                      hasFieldError('panno') ? 'text-red-400' : isValidField('panno') ? 'text-green-500' : 'text-gray-400'
                    }`} />
                    {isValidField('panno') && (
                      <CheckCircle className="absolute right-3 top-3.5 w-5 h-5 text-green-500" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label htmlFor="email" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <Mail className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    Email Address
                  </label>
                  <div className="relative">
                    <input
                ...
                {/* Mobile */}
                <div>
                  <label htmlFor="mobile" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <Phone className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    Mobile Number
                  </label>
                  <div className="relative">
                    <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="password" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <Lock className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    Password
                  </label>
                  <div className="relative">
                    <input
                ...
                <div>
                  <label htmlFor="confirm_password" className="block text-xs font-bold text-gray-600 uppercase tracking-wider mb-2">
                    <Lock className="inline w-3.5 h-3.5 mr-1.5 align-text-top" />
                    Confirm Password
                  </label>
                  <div className="relative">
              ...
              <div className="flex items-start">
                <input
                  ...
                  checked={acceptedTerms}
                  onChange={handleChange}
                  className="h-5 w-5 mt-0.5 text-primary-blue focus:ring-primary-blue border-gray-300 rounded cursor-pointer"
                />
                <label htmlFor="terms" className="ml-3 block text-sm text-gray-600 font-semibold select-none">
                  I agree to the{' '}
              ...
              {errors.terms && (
                <div className="mt-1 flex items-center text-red-600 text-xs font-semibold">
                  <AlertCircle className="w-4 h-4 mr-1 shrink-0" />
                  {errors.terms}
                </div>
              )}
        ...
        {/* Info/Hero Section - Left side on desktop */}
        <div className="lg:w-1/2 flex flex-col justify-between order-2 lg:order-1 h-full">
          <div className="bg-gradient-to-br from-primary-blue to-[#0f2a52] rounded-[32px] p-8 md:p-10 text-white shadow-2xl flex flex-col justify-between flex-grow">
            <div className="flex items-center mb-10">
              <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mr-4 border border-white/10 shrink-0">
                <User className="w-6 h-6 text-white" />
              </div>
              <div>
                <h2 className="text-2xl font-black font-sora mb-0.5 tracking-tight leading-tight">Join Our POSP Network</h2>
                <p className="text-white/70 text-xs font-semibold uppercase tracking-wider">Start your financial journey today</p>
              </div>
            </div>

            <div className="space-y-8 mb-10 flex-grow">
              <div className="flex items-start">
                <div className="bg-white/10 p-2.5 rounded-xl mr-4 border border-white/10 shrink-0">
                  <CheckCircle className="w-5 h-5 text-white/90" />
                </div>
                <div>
                  <h4 className="font-bold text-base leading-tight mb-1">Earn Commissions</h4>
                  <p className="text-sm text-white/80 font-medium">Attractive commissions on every policy</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-base leading-tight mb-1">Digital Tools</h4>
                  <p className="text-sm text-white/80 font-medium">Access to premium sales tools</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="font-bold text-base leading-tight mb-1">Training & Support</h4>
                  <p className="text-sm text-white/80 font-medium">Comprehensive training program</p>
                </div>
              </div>
            </div>
