...
function NavListMenuDesktop() {
  ...
  const renderItems = navListMenuItems.map(({ title, sublink }, key) => (
    <div className="flex lg:justify-center" key={key}>
      <div className="">
        <MenuItem
          variant="h4"
          color="blue-gray"
          className="flex items-center text-black bg-transparent hover:bg-transparent text-sm cursor-pointer font-bold font-sans"
        >
          {title}
        </MenuItem>
        ...
        {sublink.map((sublinkItem, sublinkKey) => (
          <Link
            to={sublinkItem.link}
            key={sublinkKey}
            className="text-xs text-gray-600 font-sans font-medium"
          >
            <MenuItem className="flex items-center cursor-pointer gap-2 rounded-lg py-1 px-3 hover:text-primary-blue hover:bg-blue-50/50">
              {sublinkItem.name}
            </MenuItem>
          </Link>
        ))}
      ...
      >
        <MenuHandler>
          <Typography as="div" variant="small" className="font-medium h-full flex items-center">
            <ListItem
              className={`flex items-center text-sm font-semibold h-full xl:px-4 lg:px-2 gap-2 rounded-none bg-transparent hover:bg-transparent transition-colors relative cursor-pointer ${
        ...
        <MenuList className="hidden ml-[12%] w-fit bg-transparent border-0 lg:justify-center shadow-none outline-none outline-0 lg:flex">
          <div className="w-[70vw] rounded-xl bg-white outline-none lg:block outline-0 border border-gray-100 shadow-xl p-4">
      ...
      <div className="flex lg:justify-center" key={key}>
        <div className="">
          ...
          {sublink.map((sublinkItem, sublinkKey) => (
            ...
            >
              <MenuItem className="flex items-center cursor-pointer gap-2 rounded-lg py-1 px-3">
                {sublinkItem.name}
              </MenuItem>
            </Link>
          ))}
        ...
        <div className="flex h-[60px] md:h-[68px] lg:h-[76px] items-stretch justify-between text-blue-gray-900 w-full">
          ...
          <div className="hidden items-center lg:gap-3 lg:flex">
            <Link to="/login" rel="noopener noreferrer">
              <Button
                variant="outlined"
                className="text-xs uppercase font-bold text-primary-blue border border-primary-blue bg-white hover:bg-primary-blue hover:text-white px-5 py-2.5 rounded shadow-none hover:shadow-none transition-all duration-200 font-sans"
              >
                LOG IN
              </Button>
            </Link>
            <Link to="/become-a-posp" rel="noopener noreferrer">
              <Button
                variant="filled"
                className="text-xs uppercase font-bold text-white bg-primary-blue hover:bg-blue-800 px-5 py-2.5 rounded shadow-none hover:shadow-none transition-all duration-200 font-sans"
              >
                BECOME A POSP
              </Button>
            </Link>
          ...
          <div className="flex w-full pb-3 flex-nowrap items-center gap-2 lg:hidden">
            <Link to="/login" className="w-full" rel="noopener noreferrer">
              <Button
                variant="outlined"
                size="sm"
                className="text-xs uppercase font-bold text-primary-blue border border-primary-blue bg-white w-full py-2 rounded shadow-none"
              >
                LOG IN
              </Button>
            </Link>
            <Link to="/become-a-posp" className="w-full" rel="noopener noreferrer">
              <Button
                variant="filled"
                size="sm"
                className="text-xs uppercase font-bold text-white bg-primary-blue w-full py-2 rounded shadow-none"
              >
                BECOME A POSP
              </Button>
            </Link>
